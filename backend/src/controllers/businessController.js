  ...
  updateProfile: async (req, res) => {
    try {
      const {
        ...
        pais, adreca, ciutat, codi_postal, iva_defecte, irpf_defecte, irpf_estimat, serie_defecte
      } = req.body;
      ...
      const updateData = {
        ...
        irpf_estimat: irpf_estimat ? parseFloat(irpf_estimat) : profile.irpf_estimat,
